...
function openPost(i) {
  ...
  // Show panel
  const wrap = document.querySelector('.post-detail-wrap');
  wrap.classList.add('open');
  document.querySelector('.blog-page').classList.add('has-detail');
}

function closePost() {
  document.querySelector('.post-detail-wrap').classList.remove('open');
